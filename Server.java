...
public class Server {
    ...
    static class ApiHandler implements HttpHandler {
        ...
        public ApiHandler() {
            ...
            addTopic("1", "en", "About College", "Jain College of Engineering and Research, Belgaum, Karnataka has rapidly emerged as a premier institution since its establishment in 2010, offering world-class engineering and management education. This dynamic institution is renowned for its commitment to academic excellence, innovative teaching methods, and industry-driven curriculum, making it the perfect choice for students and parents alike. With strong affiliations to VTU Belagavi and AICTE accreditation.", null);
            addTopic("1", "hi", "कॉलेज के बारे में", "जैन कॉलेज ऑफ इंजीनियरिंग एंड रिसर्च, बेलगाम, कर्नाटक 2010 में अपनी स्थापना के बाद से एक प्रमुख संस्थान के रूप में तेजी से उभरा है, जो विश्व स्तरीय इंजीनियरिंग और प्रबंधन शिक्षा प्रदान करता है। वीटीयू बेलगावी और एआईसीટીई मान्यता के साथ, कॉलेज गुणवत्तापूर्ण शिक्षा और प्रगति का प्रतीक है।", null);
            addTopic("1", "kn", "ಕಾಲೇಜಿನ ಬಗ್ಗೆ", "ಜೈನ್ ಕಾಲೇಜ್ ಆಫ್ ಇಂಜಿನಿಯರಿಂಗ್ ಅಂಡ್ ರಿಸರ್ಚ್, ಬೆಳಗಾವಿ, ಕರ್ನಾಟಕವು 2010 ರಲ್ಲಿ ಸ್ಥಾಪನೆಯಾದಂದಿನಿಂದ ವಿಶ್ವದರ್ಜೆಯ ಇಂಜಿನಿಯರಿಂಗ್ ಶಿಕ್ಷಣವನ್ನು ನೀಡುವ ಪ್ರಮುಖ ಸಂಸ್ಥೆಯಾಗಿ ಹೊರಹೊಮ್ಮಿದೆ. ವಿಟಿಯು ಬೆಳಗಾವಿ ಮತ್ತು ಎಐಸಿಟಿಇ ಮಾನ್ಯತೆಯೊಂದಿಗೆ, ಕಾಲೇಜು ಗುಣಮಟ್ಟದ ಶಿಕ್ಷಣದ ಸಂಕೇತವಾಗಿ ನಿಂತಿದೆ.", null);

            // Sub-topic: Principal
            addTopic("1_principal", "en", "Principal Sir", "DOCTOR S. V. Gorabal sir is the Principal of Jain College of Engineering and Research, Belgaum. He is a visionary leader with extensive experience in technical education and research. Under his guidance, the institution has achieved significant milestones in academic excellence and student development.", "images/principale.jpg.png", "Doctor S. V. Gorabal sir is the Principal of Jain College of Engineering and Research, Belgaum. He is a visionary leader with extensive experience in technical education and research. Under his guidance, the institution has achieved significant milestones in academic excellence and student development.");
            addTopic("1_principal", "hi", "प्राचार्य महोदय", "डॉ. एस. वी. गोरबल सर जैन कॉलेज ऑफ इंजीनियरिंग एंड रिसर्च, बेलगाम के प्राचार्य हैं। वह एक दूरदर्शी नेता हैं जिन्हें तकनीकी शिक्षा और अनुसंधान का व्यापक अनुभव है। उनके मार्गदर्शन में, संस्थान ने अकादमिक उत्कृष्टता और छात्र विकास में महत्वपूर्ण मील के पत्थर हासिल किए हैं।", "images/principale.jpg.png");
            addTopic("1_principal", "kn", "ಪ್ರಾಂಶುಪಾಲರು", "ಡಾ. ಎಸ್. ವಿ. ಗೊರಬಾಳ್ ಸರ್ ಅವರು ಬೆಳಗಾವಿಯ ಜೈನ್ ಕಾಲೇಜ್ ಆಫ್ ಇಂಜಿನಿಯರಿಂಗ್ ಅಂಡ್ ರಿಸರ್ಚ್‌ನ ಪ್ರಾಂಶುಪಾಲರಾಗಿದ್ದಾರೆ. ಅವರು ತಾಂತ್ರಿಕ ಶಿಕ್ಷಣ ಮತ್ತು ಸಂಶೋಧನೆಯಲ್ಲಿ ಅಪಾರ ಅನುಭವ ಹೊಂದಿರುವ ದಾರ್ಶನಿಕ ನಾಯಕರಾಗಿದ್ದಾರೆ. ಅವರ ಮಾರ್ಗದರ್ಶನದಲ್ಲಿ, ಸಂಸ್ಥೆಯು ಶೈಕ್ಷಣಿಕ ವಿಭಾಗ ಮತ್ತು ವಿದ್ಯಾರ್ಥಿಗಳ ಅಭಿವೃದ್ಧಿಯಲ್ಲಿ ಗಮನಾರ್ಹ ಸಾಧನೆ ಮಾಡಿದೆ.", "images/principale.jpg.png");

            // Sub-topic: College Faculty (General)
            addTopic("1_faculty", "en", "College Faculty", "JCER boasts a team of highly qualified and dedicated faculty members across all departments. Our educators are committed to student success, research, and holistic development. They bring both industrial and academic expertise to the classroom.", "images/college_faculty.jpg");
            addTopic("1_faculty", "hi", "कॉलेज फैकल्टी", "जेसीईआर के सभी विभागों में उच्च योग्य और समर्पित फैकल्टी सदस्यों की एक टीम है। हमारे शिक्षक छात्रों की सफलता और शोध के लिए प्रतिबद्ध हैं।", "images/college_faculty.jpg");
            addTopic("1_faculty", "kn", "ಕಾಲೇಜು ಬೋಧಕ ವರ್ಗ", "ಜೆಸಿಇಆರ್ ಎಲ್ಲಾ ವಿಭಾಗಗಳಲ್ಲಿ ಉನ್ನತ ಗುಣಮಟ್ಟದ ಬೋಧಕರ ತಂಡವನ್ನು ಹೊಂದಿದೆ. ಅವರು ವಿದ್ಯಾರ್ಥಿಗಳ ಅಭಿವೃದ್ಧಿಗೆ ಮತ್ತು ಸಂಶೋಧನೆಗೆ ಶ್ರಮಿಸುತ್ತಿದ್ದಾರೆ.", "images/college_faculty.jpg");

            // Topic 2: Admission
            addTopic("2", "en", "Admission Process", "Welcome to Jain College of Engineering and Research. We offer Undergraduate and Postgraduate courses in various streams. Admission can be taken through UGCET, DCET, or Management quota. \n\nWe provide courses in:\n• Computer Science & Engineering\n• Electronics & Communication Engineering\n• Artificial Intelligence & Machine Learning\n• Mechanical Engineering\n• Civil Engineering\n• MBA\n\nFor further information, please visit office room number G04 and meet Shivakumar Biradar sir. Thank you.", null);
            addTopic("2", "hi", "प्रवेश प्रक्रिया", "जैन कॉलेज ऑफ इंजीनियरिंग एंड रिसर्च में आपका स्वागत है। हम विभिन्न इंजीनियरिंग धाराओं में स्नातक पाठ्यक्रम प्रदान करते हैं। प्रवेश UGCET, DCET या प्रबंधन कोटे के माध्यम से लिया जा सकता है।\n\nहम निम्नलिखित पाठ्यक्रम प्रदान करते हैं:\n• कंप्यूटर साइंस एंड इंजीनियरिंग\n• इलेक्ट्रॉनिक्स एंड कम्युनिकेशन इंजीनियरिंग\n• आर्टिफिशियल इंटेलिजेंस और मशीन लर्निंग\n• मैकेनिकल इंजीनियरिंग\n• सिविल इंजीनियरिंग\n• एमबीए\n\nअधिक जानकारी के लिए, कृपया कार्यालय कक्ष संख्या G04 में जाएँ और शिवकुमार बिरादर सर से मिलें। धन्यवाद।", null);
            addTopic("2", "kn", "ಪ್ರವೇಶ ಪ್ರಕ್ರಿಯೆ", "ಜೈನ್ ಕಾಲೇಜ್ ಆಫ್ ಇಂಜಿನಿಯರಿಂಗ್ ಅಂಡ್ ರಿಸರ್ಚ್‌ಗೆ ಸುಸ್ವಾಗತ. ನಾವು ವಿವಿಧ ಇಂಜಿನಿಯರಿಂಗ್ ವಿಭಾಗಗಳಲ್ಲಿ ಪದವಿ ಕೋರ್ಸ್‌ಗಳನ್ನು ನೀಡುತ್ತೇವೆ. UGCET, DCET ಅಥವಾ ಮ್ಯಾನೇಜ್‌ಮೆಂಟ್ ಕೋಟಾದ ಮೂಲಕ ಪ್ರವೇಶ ಪಡೆಯಬಹುದು.\n\nನಾವು ಈ ಕೆಳಗಿನ ಕೋರ್ಸ್‌ಗಳನ್ನು ನೀಡುತ್ತೇವೆ:\n• ಕಂಪ್ಯೂಟರ್ ಸೈನ್ಸ್ ಅಂಡ್ ಇಂಜಿನಿಯರಿಂಗ್\n• ಎಲೆಕ್ಟ್ರಾನಿಕ್ಸ್ ಅಂಡ್ ಕಮ್ಯುನಿಕೇಷನ್ ಇಂಜಿನಿಯರಿಂಗ್\n• ಆರ್ಟಿಫಿಶಿಯಲ್ ಇಂಟೆಲಿಜೆನ್ಸ್ ಮತ್ತು ಮಷಿನ್ ಲರ್ನಿಂಗ್\n• ಮೆಕ್ಯಾನಿಕಲ್ ಇಂಜಿನಿಯರಿಂಗ್\n• ಸಿವಿಲ್ ಇಂಜಿನಿಯರಿಂಗ್\n• ಎಂಬಿಎ\n\nಹೆಚ್ಚಿನ ಮಾಹಿತಿಗಾಗಿ, ದಯವಿಟ್ಟು ಕಚೇರಿ ಕೊಠಡಿ ಸಂಖ್ಯೆ G04 ಗೆ ಭೇಟಿ ನೀಡಿ ಮತ್ತು ಶಿವಕುಮಾರ್ ಬಿರಾದಾರ್ ಸರ್ ಅವರನ್ನು ಭೇಟಿ ಮಾಡಿ. ಧನ್ಯವಾದಗಳು.", null);
            
            addTopic("2_ugcet", "en", "UGCET Admission", "UGCET (KCET) admission is for students seeking entry into the first year of engineering. Candidates must participate in the KEA counseling process based on their CET rank. JCER generally follows the Karnataka government-mandated fee structure for CET (KCET) students, which is approximately ₹90,000 to ₹1 Lakh per year (around ₹3.6 Lakhs - ₹4 Lakhs for 4 years) for tuition, excluding additional college/exam fees. The KCET code for JCER is E269.", null);
            addTopic("2_dcet", "en", "DCET Admission", "DCET admission is for Diploma students seeking lateral entry into the second year (3rd semester) of engineering. Candidates must clear the Diploma CET and participate in counseling. The total fee for the BE {Lateral} course at JCER is approximately ₹3.67 Lakhs to ₹6 Lakhs for the entire duration.", null);
            addTopic("2_management", "en", "Management Admission", "For direct admission under Management Quota, please visit the college office at room G04 and meet Shivakumar Biradar sir. You can also contact us at principal@jcer.in for fee details.", null);
            
            addTopic("2_faculty", "en", "Admission Team", "For admission related queries, please contact our dedicated admission cell led by Shivakumar Biradar sir.", "images/faculty_admission.jpg");
            addTopic("2_faculty", "hi", "प्रवेश टीम", "प्रवेश संबंधी पूछताछ के लिए, कृपया शिवकुमार बिरादर सर के नेतृत्व वाली हमारी समर्पित प्रवेश टीम से संपर्क करें।", "images/faculty_admission.jpg");
            addTopic("2_faculty", "kn", "ಪ್ರವೇಶ ತಂಡ", "ಪ್ರವೇಶಕ್ಕೆ ಸಂಬಂಧಿಸಿದ ವಿಚಾರಣೆಗಾಗಿ, ದಯವಿಟ್ಟು ಶಿವಕುಮಾರ್ ಬಿರಾದಾರ್ ಸರ್ ನೇತೃತ್ವದ ನಮ್ಮ ಪ್ರವೇಶ ತಂಡವನ್ನು ಸಂಪರ್ಕಿಸಿ.", "images/faculty_admission.jpg");

            // Topic 3: CSE Department
            addTopic("3", "en", "Computer Science & Engineering", "The Department of Computer Science & Engineering was established in 2018 with an intake of 120, and a dedicated Research Center was established in 2024. We are committed to continuously improving the quality of education with highly qualified staff and centralized laboratories featuring the latest software tools. Our four-year undergraduate program provides a solid foundation in CSE principles and emerging technologies, equipping students to solve complex problems and succeed in the IT industry.", "images/cse_dept.jpg.jpeg");
            addTopic("3", "hi", "कंप्यूटर साइंस एंड इंजीनियरिंग", "कंप्यूटर विज्ञान और इंजीनियरिंग विभाग 2018 में 120 की प्रवेश क्षमता के साथ स्थापित किया गया था, और 2024 में एक समर्पित अनुसंधान केंद्र स्थापित किया गया था। हम उच्च योग्य संकाय और नवीनतम सॉफ्टवेयर उपकरणों वाली केंद्रीकृत प्रयोगशालाओं के साथ शिक्षा की गुणवत्ता में निरंतर सुधार के लिए प्रतिबद्ध हैं। हमारा चार साल का स्नातक कार्यक्रम सीएसई सिद्धांतों और उभरती प्रौद्योगिकियों में एक ठोस आधार प्रदान करता है।", "images/cse_dept.jpg.jpeg");
            addTopic("3", "kn", "ಕಂಪ್ಯೂಟರ್ ಸೈನ್ಸ್ ಅಂಡ್ ಇಂಜಿನಿಯರಿಂಗ್", "ಕಂಪ್ಯೂಟರ್ ಸೈನ್ಸ್ ಮತ್ತು ಇಂಜಿನಿಯರಿಂಗ್ ವಿಭಾಗವನ್ನು 2018 ರಲ್ಲಿ 120 ರ ಮೊತ್ತದೊಂದಿಗೆ ಸ್ಥಾಪಿಸಲಾಯಿತು ಮತ್ತು 2024 ರಲ್ಲಿ ಸಂಶೋಧನಾ ಕೇಂದ್ರವನ್ನು ಸ್ಥಾಪಿಸಲಾಯಿತು. ನಾವು ಉನ್ನತ ಗುಣಮಟ್ಟದ ಬೋಧಕರ ತಂಡ ಮತ್ತು ಇತ್ತೀಚಿನ ಸಾಫ್ಟ್‌ವೇರ್ ಪರಿಕರಗಳೊಂದಿಗೆ ಗುಣಮಟ್ಟದ ಶಿಕ್ಷಣವನ್ನು ನೀಡಲು ಬದ್ಧರಾಗಿದ್ದೇವೆ. ನಮ್ಮ ನಾಲ್ಕು ವರ್ಷಗಳ ಪದವಿ ಕಾರ್ಯಕ್ರಮವು ಸಿಎಸ್‌ಇ ತತ್ವಗಳು ಮತ್ತು ಉದಯೋನ್ಮುಖ ತಂತ್ರಜ್ಞಾನಗಳಲ್ಲಿ ಭದ್ರ ಬುನಾದಿಯನ್ನು ಒದಗಿಸುತ್ತದೆ.", "images/cse_dept.jpg.jpeg");
            addTopic("3_faculty", "en", "CSE Faculty Members", "The CSE department features a distinguished team of experts: \n\n" +
            ...
            addTopic("4", "en", "Electronics & Communication", "The Department of Electronics & Communication Engineering was established in 2018 with an intake of 60, which increased to 90 in 2023. A dedicated Research Center was established in 2024. The department is committed to imparting quality education and fostering innovation in electronics and communication technologies, preparing students for dynamic careers in academia, industry, and research.", "images/ece_dpt.jpg.jpeg");
            addTopic("4", "hi", "इलेक्ट्रॉनिक्स एंड कम्युनिकेशन", "इलेक्ट्रॉनिक्स और संचार इंजीनियरिंग विभाग 2018 में स्थापित किया गया था। यह विभाग गुणवत्तापूर्ण शिक्षा और नवाचार के लिए समर्पित है, जो छात्रों को आधुनिक तकनीकों, अनुसंधान और उद्योग की चुनौतियों के लिए तैयार करता है। 2024 में यहां एक शोध केंद्र भी शुरू किया गया है।", "images/ece_dpt.jpg.jpeg");
            addTopic("4", "kn", "ಎಲೆಕ್ಟ್ರಾನಿಕ್ಸ್ ಅಂಡ್ ಕಮ್ಯುನಿಕೇಷನ್", "ಎಲೆಕ್ಟ್ರಾನಿಕ್ಸ್ ಮತ್ತು ಕಮ್ಯುನಿಕೇಷನ್ ಇಂಜಿನಿಯರಿಂಗ್ ವಿಭಾಗವನ್ನು 2018 ರಲ್ಲಿ ಸ್ಥಾಪಿಸಲಾಯಿತು. ವಿಭಾಗವು ಗುಣಮಟ್ಟದ ಶಿಕ್ಷಣ ಮತ್ತು ನಾವೀನ್ಯತೆಗೆ ಸಮರ್ಪಿತವಾಗಿದೆ, ಇದು ಆಧುನಿಕ ತಂತ್ರಜ್ಞಾನಗಳು, ಸಂಶೋಧನೆ ಮತ್ತು ಉದ್ಯಮದ ಸವಾಲುಗಳಿಗೆ ವಿದ್ಯಾರ್ಥಿಗಳನ್ನು ಸಿದ್ಧಪಡಿಸುತ್ತದೆ.", "images/ece_dpt.jpg.jpeg");
            addTopic("4_faculty", "en", "ECE Faculty Members", "The ECE department features a distinguished team of experts: \n\n" +
            ...
            addTopic("5", "en", "Artificial Intelligence & ML", "The Department of Computer Science & Engineering (Artificial Intelligence and Machine Learning) was established in 2023 with an intake of 60. It is a dynamic and growing hub of innovation at JCER, Belagavi. Despite being new, our department has quickly established itself as a center for learning, offering a cutting-edge curriculum tailored to the ever-evolving fields of AI and ML. Our students are currently in their 7th semester, actively engaging with the latest technologies and hands-on projects.", "images/AIML_dept.jpg.jpeg");
            addTopic("5", "hi", "आर्टिफिशियल इंटेलिजेंस और मशीन लर्निंग", "कंप्यूटर विज्ञान और इंजीनियरिंग विभाग (आर्टिफिशियल इंटेलिजेंस और मशीन लर्निंग) 2023 में 60 की प्रवेश क्षमता के साथ स्थापित किया गया था। यह जेसीईआर, बेलगावी में नवाचार का एक गतिशील और बढ़ता हुआ केंद्र है। नया होने के बावजूद, हमारे विभाग ने खुद को सीखने के केंद्र के रूप में तेजी से स्थापित किया है, जो एआई और एमएल के निरंतर विकसित होने वाले क्षेत्रों के लिए तैयार किया गया एक अत्याधुनिक पाठ्यक्रम पेश करता है। हमारे छात्र वर्तमान में अपने 7वें सेमेस्टर में हैं, जो नवीनतम तकनीकों और व्यावहारिक परियोजनाओं के साथ सक्रिय रूप से जुड़े हुए हैं।", "images/AIML_dept.jpg.jpeg");
            addTopic("5", "kn", "ಆರ್ಟಿಫಿಶಿಯಲ್ ಇಂಟೆಲಿಜೆನ್ಸ್ ಮತ್ತು ಮಷಿನ್ ಲರ್ನಿಂಗ್", "ಕಂಪ್ಯೂಟರ್ ಸೈನ್ಸ್ ಮತ್ತು ಇಂಜಿನಿಯರಿಂಗ್ ವಿಭಾಗವನ್ನು (ಆರ್ಟಿಫಿಶಿಯಲ್ ಇಂಟೆಲಿಜೆನ್ಸ್ ಮತ್ತು ಮಷಿನ್ ಲರ್ನಿಂಗ್) 2023 ರಲ್ಲಿ 60 ರ ಮೊತ್ತದೊಂದಿಗೆ ಸ್ಥಾಪಿಸಲಾಯಿತು. ಇದು ಬೆಳಗಾವಿಯ JCER ನಲ್ಲಿ ನಾವೀನ್ಯತೆಯ ಕ್ರಿಯಾತ್ಮಕ ಮತ್ತು ಬೆಳೆಯುತ್ತಿರುವ ಕೇಂದ್ರವಾಗಿದೆ. ಹೊಸದಾಗಿದ್ದರೂ, ನಮ್ಮ ವಿಭಾಗವು ಕಲಿಕೆಯ ಕೇಂದ್ರವಾಗಿ ವೇಗವಾಗಿ ಸ್ಥಾಪಿತವಾಗಿದೆ, ಇದು AI ಮತ್ತು ML ನ ನಿರಂತರವಾಗಿ ವಿಕಸನಗೊಳ್ಳುತ್ತಿರುವ ಕ್ಷೇತ್ರಗಳಿಗೆ ಅನುಗುಣವಾಗಿ ಅತ್ಯಾಧುನಿಕ ಪಠ್ಯಕ್ರಮವನ್ನು ನೀಡುತ್ತದೆ. ನಮ್ಮ ವಿದ್ಯಾರ್ಥಿಗಳು ಪ್ರಸ್ತುತ ತಮ್ಮ 7 ನೇ ಸೆಮಿಸ್ಟರ್‌ನಲ್ಲಿದ್ದಾರೆ ಮತ್ತು ಇತ್ತೀಚಿನ ತಂತ್ರಜ್ಞಾನಗಳು ಮತ್ತು ಯೋಜನೆಗಳಲ್ಲಿ ತೊಡಗಿಸಿಕೊಂಡಿದ್ದಾರೆ.", "images/AIML_dept.jpg.jpeg");
            addTopic("5_faculty", "en", "AI & ML Faculty Members", "The AI & ML department features a distinguished team of experts: \n\n" +
            ...
            addTopic("6", "en", "Mechanical Engineering", "The Department of Mechanical Engineering was established in 2018 with an intake of 60, and a dedicated Research Center was added in 2024. To facilitate students, the department offers well-equipped laboratories and modern infrastructure. Our highly qualified faculty are dedicated to taking extra initiatives to mold students, preparing them to face the challenges of the competitive world.", "images/mechanical_dpt.jpg.jpeg");
            addTopic("6", "hi", "मैकेनिकल इंजीनियरिंग", "मैकेनिकल इंजीनियरिंग विभाग 2018 में 60 की प्रवेश क्षमता के साथ स्थापित किया गया था, और 2024 में एक समर्पित अनुसंधान केंद्र भी जोड़ा गया था। छात्रों की बेहतर शिक्षा के लिए, विभाग में उच्च तकनीक वाली प्रयोगशालाएं और आधुनिक बुनियादी ढांचा उपलब्ध है। हमारे अनुभवी और उच्च स्तरीय शिक्षक छात्रों को भविष्य की चुनौतियों के लिए तैयार करने और उनके सर्वांगीण विकास के लिए निरंतर प्रयास करते हैं।", "images/mechanical_dpt.jpg.jpeg");
            addTopic("6", "kn", "ಮೆಕ್ಯಾನಿಕಲ್ ಇಂಜಿನಯರಿಂಗ್", "ಮೆಕ್ಯಾನಿಕಲ್ ಇಂಜಿನಿಯರಿಂಗ್ ವಿಭಾಗವನ್ನು 2018 ರಲ್ಲಿ 60 ವಿದ್ಯಾರ್ಥಿಗಳ ಸಾಮರ್ಥ್ಯದೊಂದಿಗೆ ಸ್ಥಾಪಿಸಲಾಯಿತು ಮತ್ತು 2024 ರಲ್ಲಿ ಸಂಶೋಧನಾ ಕೇಂದ್ರವನ್ನು ಪ್ರಾರಂಭಿಸಲಾಯಿತು. ವಿದ್ಯಾರ್ಥಿಗಳಿಗೆ ಉತ್ತಮ ಪ್ರಾಯೋಗಿಕ ಜ್ಞಾನ ನೀಡಲು ವಿಭಾಗವು ಅತ್ಯಾಧುನಿಕ ಪ್ರಯೋಗಾಲಯಗಳು ಮತ್ತು ಆಧುನಿಕ ಮೂಲಸೌಕರ್ಯಗಳನ್ನು ಹೊಂದಿದೆ. ನಮ್ಮ ಅನುಭವಿ ಬೋಧಕ ವರ್ಗವು ವಿದ್ಯಾರ್ಥಿಗಳನ್ನು ಜಾಗತಿಕ ಸ್ಪರ್ಧೆ ಎದುರಿಸಲು ಸಿದ್ಧಪಡಿಸುವಲ್ಲಿ ಸದಾ ಶ್ರಮಿಸುತ್ತದೆ.", "images/mechanical_dpt.jpg.jpeg");
            addTopic("6_faculty", "en", "Mechanical Faculty Members", "The Mechanical Engineering department features a distinguished team of experts: \n\n" +
            ...
            addTopic("8", "en", "Applied Science", "The Basic Science Department is dedicated to laying a robust foundation in core principles of science, shaping the analytical and problem-solving skills of future engineers. Our team of highly qualified faculty is passionate about nurturing curiosity and academic excellence. Equipped with state-of-the-art laboratories and advanced teaching methodologies, we ensure an engaging learning experience. This solid grounding empowers students to excel throughout their engineering journey, setting the stage for innovative thinking and success in a technologically driven world.", "images/Appscience_dept.jpg.jpeg");
            addTopic("8", "hi", "एप्लाइड साइंस", "बेसिक साइंस विभाग इंजीनियरिंग की नींव रखने के लिए समर्पित है। हम भविष्य के इंजीनियरों के विश्लेषणात्मक कौशल को विकसित करने पर ध्यान केंद्रित करते हैं।", "images/Appscience_dept.jpg.jpeg");
            addTopic("8", "kn", "ಅಪ್ಲೈಡ್ ಸೈನ್ಸ್", "ಬೇಸಿಕ್ ಸೈನ್ಸ್ ವಿಭಾಗವು ಇಂಜಿನಿಯರಿಂಗ್‌ನ ಅಡಿಪಾಯ ಹಾಕಲು ಸಮರ್ಪಿತವಾಗಿದೆ. ಭವಿಷ್ಯದ ಇಂಜಿನಿಯರ್‌ಗಳ ವಿಶ್ಲೇಷಣಾತ್ಮಕ ಕೌಶಲ್ಯಗಳನ್ನು ಅಭಿವೃದ್ಧಿಪಡಿಸುವತ್ತ ನಾವು ಗಮನ ಹರಿಸುತ್ತೇವೆ.", "images/Appscience_dept.jpg.jpeg");
            addTopic("8_faculty", "en", "Applied Science Faculty Members", "The Applied Science department features a distinguished team of experts: \n\n" +
            ...
            // Topic 9: MBA
            addTopic("9", "en", "MBA Department", "Established in 2024, our dynamic Department of MBA focuses on Digital Disruption, Analytics, and Modern Management practices. The department aims to develop visionary leaders equipped with contemporary management skills and an ethical mindset.", "images/MBA_dept.jpg.jpeg");
            addTopic("9", "hi", "एमबीए विभाग", "2024 में स्थापित हमारा एमबीए विभाग आधुनिक प्रबंधन प्रथाओं और डिजिटल नवाचार पर केंद्रित है।", "images/MBA_dept.jpg.jpeg");
            addTopic("9", "kn", "ಎಂಬಿಎ ವಿಭಾಗ", "2024 ರಲ್ಲಿ ಸ್ಥಾಪನೆಯಾದ ನಮ್ಮ ಎಂಬಿಎ ವಿಭಾಗವು ಆಧುನಿಕ ನಿರ್ವಹಣಾ ಪದ್ಧತಿಗಳು ಮತ್ತು ಡಿಜಿಟಲ್ ನಾವೀನ್ಯತೆಗಳ ಮೇಲೆ ಕೇಂದ್ರೀಕರಿಸುತ್ತದೆ.", "images/MBA_dept.jpg.jpeg");
            addTopic("9_faculty", "en", "MBA Faculty Members", "The MBA department features a distinguished team of experts: \n\n" +
            ...
            // Topic 10: Rules
            addTopic("10", "en", "College Rules", "Character building is our main aim. Discipline, attendance, and ethics are strictly enforced at JCER.", null);
            addTopic("10", "hi", "कॉलेज के नियम", "अनुशासन, उपस्थिति और नैतिकता जेसीईआर में दृढ़ता से लागू की जाती है। छात्र का सर्वांगीण विकास हमारा मुख्य लक्ष्य है।", null);
            addTopic("10", "kn", "ಕಾಲೇಜು ನಿಯಮಗಳು", "ಶಿಸ್ತು, ಹಾಜರಾತಿ ಮತ್ತು ನೈತಿಕತೆಯನ್ನು ಜೆಸಿಇಆರ್ ನಲ್ಲಿ ಕಟ್ಟುನಿಟ್ಟಾಗಿ ಜಾರಿಗೊಳಿಸಲಾಗಿದೆ. ವಿದ್ಯಾರ್ಥಿಯ ಸರ್ವತೋಮುಖ ಅಭಿವೃದ್ಧಿ ನಮ್ಮ ಮುಖ್ಯ ಗುರಿಯಾಗಿದೆ.", null);

            // Topic 11: Canteen
            addTopic("11", "en", "Canteen", "Our college canteen is very clean and well maintained. The surroundings are neat, and proper hygiene is followed while preparing food. Clean water is available, and the seating area is comfortable for students to sit and relax.\n\nThe food in our canteen is very tasty and fresh. Different types of snacks, meals, and drinks are available.", null);
            addTopic("11", "hi", "कैंटीन", "हमारा कॉलेज कैंटीन बहुत साफ और स्वच्छ है। हम छात्रों के लिए ताजा और स्वादिष्ट भोजन और बैठने के लिए आरामदायक जगह प्रदान करते हैं।", null);
            addTopic("11", "kn", "ಕ್ಯಾಂಟೀನ್", "ನಮ್ಮ ಕಾಲೇಜು ಕ್ಯಾಂಟೀನ್ ತುಂಬಾ ಸ್ವಚ್ಛ ಮತ್ತು ನೈರ್ಮಲ್ಯದಿಂದ ಕೂಡಿದೆ. ನಾವು ವಿದ್ಯಾರ್ಥಿಗಳಿಗೆ ತಾಜಾ ಮತ್ತು ರುಚಿಕರವಾದ ಆಹಾರ ಮತ್ತು ಕುಳಿತುಕೊಳ್ಳಲು ಆರಾಮದಾಯಕವಾದ ಸ್ಥಳವನ್ನು ಒದಗಿಸುತ್ತೇವೆ.", null);

            // Topic 12: Facilities
            addTopic("12", "en", "Campus Facilities", "JCER offers world-class infrastructure to support your academic journey: \n\n" +
            ...
            addTopic("12", "hi", "कैंपस सुविधाएं", "जेसीईआर विश्व स्तरीय बुनियादी ढांचा प्रदान करता है, जिसमें आधुनिक प्रयोगशालाएं, उच्च गति इंटरनेट, एक विशाल पुस्तकालय और खेल सुविधाएं शामिल हैं।", "images/Facility.jpg.jpeg");
            addTopic("12", "kn", "ಕ್ಯಾಂಪಸ್ ಸೌಲಭ್ಯಗಳು", "ಜೆಸಿಇಆರ್ ಆಧುನಿಕ ಪ್ರಯೋಗಾಲಯಗಳು, ಹೈ-ಸ್ಪೀಡ್ ಇಂಟರ್ನೆಟ್, ಬೃಹತ್ ಗ್ರಂಥಾಲಯ ಮತ್ತು ಕ್ರೀಡಾ ಸೌಲಭ್ಯಗಳನ್ನು ಒಳಗೊಂಡಂತೆ ವಿಶ್ವದರ್ಜೆಯ ಮೂಲಸೌಕರ್ಯಗಳನ್ನು ಒದಗಿಸುತ್ತದೆ.", "images/Facility.jpg.jpeg");

            // Topic #: Contact
            addTopic("#", "en", "Contact Us", "Contact us via email at principal@jcer.in or call us at 09448693987.", "images/contact.jpg.jpeg");
            addTopic("#", "hi", "संपर्क करें", "आप हमें principal@jcer.in पर ईमेल कर सकते हैं या 09448693987 पर कॉल कर सकते हैं।", "images/contact.jpg.jpeg");
            addTopic("#", "kn", "ಸಂಪರ್ಕಿಸಿ", "ನೀವು ನಮಗೆ principal@jcer.in ನಲ್ಲಿ ಇಮೇಲ್ ಮಾಡಬಹುದು ಅಥವಾ 09448693987 ಗೆ ಕರೆ ಮಾಡಬಹುದು.", "images/contact.jpg.jpeg");
        }
        ...
        public void handle(HttpExchange exchange) throws IOException {
            ...
            if (query != null) {
                ...
                for (String param : params) {
                    ...
                    if (pair.length > 1) {
                        try {
                        if (pair[0].equals("topic")) topic = URLDecoder.decode(pair[1], StandardCharsets.UTF_8.name());
                                if (pair[0].equals("lang")) lang = URLDecoder.decode(pair[1], StandardCharsets.UTF_8.name());
            ...
            if (topicMap != null) {
                ...
                String spokenTextJson = info.spokenText != null ? String.format(", \"spokenText\": \"%s\"", escapeJson(info.spokenText)) : "";
                String jsonResponse = String.format("{\"title\": \"%s\", \"text\": \"%s\"%s%s}", escapeJson(info.title), escapeJson(info.text), imageUrlJson, spokenTextJson);
